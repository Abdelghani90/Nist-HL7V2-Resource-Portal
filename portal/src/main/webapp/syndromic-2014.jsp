	...
	<div class="appContent">
		...
		<div class="brand" id="appheader">
			<a style="display: inline-block; text-shadow: none" href="#">
				<div id="apptitle">
					<span style="color: white" class="ng-binding"> Syndromic
						Surveillance (2014 Edition)</span>
					<!-- <span
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<span style="color: red"> Note: The NIST 2014 Edition of The
						Syndromic Surveillance Validation Suite is no longer supported.
						However, the tool can be downloaded and ran locally. See below. </span> 
					<br/>
					<br/>
					...
					<div id="mainPanel_content"
						...
						<p>
							The NIST Syndromic Surveillance Validation Suite is intended for
							certifying 2014 Edition Meaningful Use EHR technology. The
							validation suite provides functionality to test EHR senders. The
							Syndromic Surveillance test tool covers the <i>§170.314(f)(3)
								Transmission to public health agencies - Syndromic Surveillance</i>
							Test Procedure. Use the <i>Context-based Validation</i> Tab for
							Meaningful Use certification testing.
						</p>
						<p>
							A Google Group (<a
								href="https://groups.google.com/d/forum/hl7v2-syndromic-testing">HL7v2
								Syndromic Testing</a>) has been established for discussion/questions
							of the Implementation Guide, testing tool and testing issues. No
							membership is required. A google account is required for posting.
						</p>
						<ul style="padding-left: 40px">
							<li>Site: <a
								href="https://groups.google.com/d/forum/hl7v2-syndromic-testing">https://groups.google.com/d/forum/hl7v2-syndromic-testing</a></li>
							<li>Email: hl7v2-syndromic-testing@googlegroups.com</li>
						</ul>
				...
				<div class="panel-body">
					...
					<ul>
						<li class="link">Latest War File: <a
							href="http://svn.code.sf.net/p/mu-nist/code/tags/mu-syndromic-1.7.2.zip"
							target="_blank"> v1.7.2</a>
						</li>
						<li class="link"><a
							href="resources/static/syndromic-2014/Installation-Guide-Syndromic.docx"
